<template>
  <div v-if="slides.length" class="carousel slide" @mouseout="play" @mouseover="stop">
      ...
      <div class="carousel-indicators">
        <li v-for="n in slides.length" :key="n.index" :class="{ active: n - 1 === currentIndex }" @click="playTo(n - 1)"></li>
    </div>
  </div>
</template>
