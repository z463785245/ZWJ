    ...
    <div class="container">
      <div class="row footer-top">
        <div class="col-sm-5 col-lg-5">
          ...
          <div class="text-md">
            <a v-for="item in contacts" v-title="item.title" :href="item.link" :style="contactStyle" target="_blank" :key="item.index">
          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li v-for="item in sponsor.list" :key="item.index">
            ...
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li v-for="item in statistics.list" :key="item.index">{{ item.title }}: {{ item.description }}</li>
              </ul>
            </div>
            ...
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li v-for="item in other.list" :key="item.index">
